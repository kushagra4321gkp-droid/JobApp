...
<head>
	...
	<title>Kushagra Job Portal</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
	<div class="container">
		<a class="navbar-brand fs-1 fw-medium" href="#">Kushagra Job Portal Web App</a>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ms-auto">
				...
				<li class="nav-item"><a class="nav-link" href="https://kushagra-portfolio-kappa.vercel.app/">Contact</a></li>
			</ul>
		</div>
	</div>
</nav>
